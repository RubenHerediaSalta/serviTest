...
function Profile() {
  ...
  return (
    <>
      {isLoaded && (
        <div className="flex flex-col items-center justify-start min-h-[80vh] gap-3 p-4 md:p-8">
          {errorMessage && (
            <div>
          ...
          <div className="flex flex-col items-center w-full gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full md:w-[500px]">
              <div>
            ...
            <div className="flex flex-col w-full md:w-[500px]">
              <label className={labelClassName} htmlFor="description">
                Escriba una descripción de su perfil
              </label>
              <textarea
                name="description"
                id="description"
            ...
            <button
              className="border text-lg font-semibold px-5 py-3 border-[#0a0a70] bg-[#0a0a70] text-white rounded-md"
              type="button"
              onClick={() => router.push("/")}
            >
              Volver al inicio

  ...
  return (
    <div className="mb-10">
      <h3 className="text-2xl my-5 font-normal   text-[#404145]">
        Deja un comentario y puntuacion.
      </h3>
      ...
      <div className="flex  flex-col  items-start justify-start gap-3">
        ...
        <button
          className="flex items-center bg-[#2499c7] text-white font-bold hover:bg-blue-800 py-2 justify-center text-md relative rounded px-5"
          onClick={addReview}
        >
          Agregar
        </button>

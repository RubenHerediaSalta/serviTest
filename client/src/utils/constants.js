...
export const FAVORITES_ROUTES = `${API_URL}/favorites`;
export const ADD_FAVORITE_ROUTE = `${FAVORITES_ROUTES}/add-favorite`;
export const REMOVE_FAVORITE_ROUTE = `${FAVORITES_ROUTES}/remove-favorite`;
export const CHECK_FAVORITE_ROUTE = `${FAVORITES_ROUTES}/check-favorite`;
